      ...
      {plantsArray.map((categoryData) => (
        <div key={categoryData.category} className="category-section">
          ...
          <p className="category-description">
            {categoryData.category === "Air Purifying Plants" &&
              "These plants are excellent for improving indoor air quality and removing toxins."}
            {categoryData.category === "Aromatic Fragrant Plants" &&
              "Plants with pleasant scents that can enhance your mood and environment."}
            {categoryData.category === "Insect Repellent Plants" &&
              "Natural plants that help keep unwanted insects away from your home."}
            {categoryData.category === "Medicinal Plants" &&
              "Plants with properties that can be used for home remedies and healing."}
            {categoryData.category === "Low Maintenance Plants" &&
              "Perfect plants for beginners or busy people who want greenery with minimal care."}
          </p>
